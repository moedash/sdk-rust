...
const NOT_VALIDATED_FIELDS: &[&str] = &[
    ...
    // Stream messages: the blob limit is a per-event limit, and these bodies never reach an
    ...
    "temporal.api.stream.v1.StreamMessage.body",
    "temporal.api.stream.v1.StreamMessage.metadata",
